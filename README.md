...
Once installed, you need to register the `AltThree\Storage\StorageServiceProvider` service provider in your `config/app.php`, or if you're using Laravel 5.5, this can be done via the automatic package discovery.
